...
export default function Contact() {
    return (
        <footer id="contact" className="mt-[300px] pb-[20px] flex flex-col justify-center items-center">
            ...
            <div className="mt-[80px] flex max-[1024px]:flex-col flex-row justify-center items-center gap-10">
                <div className="flex flex-row justify-center items-center gap-2 text-darkergray">
                    <img className="max-[480px]:w-[25px] max-[600px]:w-[29px] max-[1024px]:w-[31px] w-[33px]" src="/src/assets/email.png" alt="" />
                    <p className="max-[480px]:text-[1rem] max-[600px]:text-[1.1rem] max-[1024px]:text-[1.2rem] text-[1.3rem]">carldrewx@gmail.com</p>
                </div>

                <div className="flex flex-row justify-center items-center gap-2 text-darkergray">
                    <img className="max-[480px]:w-[25px] max-[600px]:w-[29px] max-[1024px]:w-[31px] w-[33px]" src="/src/assets/linkedin.png" alt="" />
