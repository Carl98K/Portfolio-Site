export default function Unity() {
    return (
        <svg fill="#000000" className="max-[480px]:w-[40px] max-[768px]:w-[60px] max-[768px]:h-[60px] max-[1024px]:w-[80px] max-[1024px]:h-[80px] max-[480px]:h-[40px] w-[100px] h-[100px]" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
            <title>unity</title>
